...
function OnWebTWAINModuleDownloadManually(objInstallerUrl, iPlatform, bSafari, bSSL) {
	var browserActionNeeded, ObjString = [
		'<div class="dynamsoft-dwt-dlg-title">',
		'Please download and install the scan module manually.',
		'</div>',
		'<div style="margin:20px;text-align:center">',
		'*The automatic installation of the module failed',
		'<a id="dwt-btn-install" target="_blank" href="',
		objInstallerUrl['default'],
		'" onclick="DCP_DWT_onclickInstallButton(this)"><div class="dynamsoft-dwt-dlg-button">Download</div></a></div>',
	];
	if (iPlatform == EnumDWT_PlatformType.enumLinux || navigator.userAgent.toLowerCase().indexOf("firefox") > -1) {
		browserActionNeeded = 'RESTART';
	}
