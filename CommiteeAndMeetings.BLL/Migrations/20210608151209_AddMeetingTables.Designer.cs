...
namespace CommiteeAndMeetings.BLL.Migrations
{
    ...
    [Migration("20210608151209_AddMeetingTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.MeetingDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MeetingDates", "Meeting");
                });

            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.MeetingLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MeetingLocations", "Meeting");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.TopicType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("TopicTypeNameAr")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TopicTypeNameEn")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("TopicTypes", "Meeting");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.MeetingTopic", b =>
                {
                    b.HasOne("CommiteeAndMeetings.DAL.MeetingDomains.Meeting", null)
                        .WithMany("MeetingTopics")
                        .HasForeignKey("MeetingId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CommiteeAndMeetings.DAL.MeetingDomains.MinuteOfMeeting", null)
                        .WithMany("Topics")
                        .HasForeignKey("MinuteOfMeetingId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CommiteeAndMeetings.DAL.MeetingDomains.TopicType", "TopicType")
                        .WithMany()
