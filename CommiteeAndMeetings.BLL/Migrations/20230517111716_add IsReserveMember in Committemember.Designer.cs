...
namespace CommiteeAndMeetings.BLL.Migrations
{
    ...
    [Migration("20230517111716_add IsReserveMember in Committemember")]
    partial class addIsReserveMemberinCommittemember
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDTO.Vw_ReturnGroupReferralDTO", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ReceipientsIds")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TransactionActionFormated")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Vw_ReturnGroupReferralDTO");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeMember", b =>
                {
                    ...
                    b.Property<bool>("IsReserveMember")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeTaskEscalation", b =>
                {
                    b.Property<int>("CommiteeTaskEscalationIndex")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("NewMainAssinedUserId")
                        .HasColumnType("int");

                    b.HasKey("CommiteeTaskEscalationIndex");

                    b.HasIndex("MainAssinedUserId");

                    b.HasIndex("NewMainAssinedUserId");

                    b.HasIndex("ComiteeTaskCategoryId", "MainAssinedUserId", "NewMainAssinedUserId", "DelayPeriod")
                        .IsUnique()
                        .HasFilter("[ComiteeTaskCategoryId] IS NOT NULL");

                    b.ToTable("CommiteeTaskEscalation", "Committe");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeTaskMultiMission", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("EndDateMultiMission")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeTaskMultiMissionUser", b =>
                {
                    b.Property<int>("CommiteeTaskMultiMissionUserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("CommiteeTaskMultiMissionUserId");

                    b.HasIndex("CommiteeTaskMultiMissionId");

                    b.HasIndex("CreatedByRoleId");

                    b.HasIndex("UserId");

                    b.ToTable("CommiteeTaskMultiMissionUsers", "Committe");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.Group", b =>
                {
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.GroupUsers", b =>
                {
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.TaskGroups", b =>
                {
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.UserRoleRequest", b =>
                {
                    b.Property<int>("UserRoleRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("UserRoleStatus")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("UserRoleRequestId");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.ViewPermissionCategoryView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ViewPermissionCategoryView");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.VwLookUpReturnUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.Vw_String", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("valAsString")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.MeetingAttendee", b =>
                {
                    ...
                    b.Property<int?>("AlternativeAttendeeId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReasonForReplacing")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("UserDelegateUserId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("AlternativeAttendeeId");

                    b.HasIndex("AttendeeId");

                    b.HasIndex("MeetingId");

                    b.HasIndex("UserDelegateUserId");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.MeetingCoordinator", b =>
                {
                    ...
                    b.Property<int?>("AlternativeCoordinatorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AlternativeCoordinatorId");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.MinuteOfMeeting", b =>
                {
                    ...
                    b.Property<bool>("EmailSentInvitation")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Views.Vm_EmpInOrgaHierarchy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("vm_EmpInOrgaHierarchies");
                });

            modelBuilder.Entity("CommiteeAndMeetings.DAL.Views.Vm_OrgInOrgaHierarchy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("OrganizationAr")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Vm_OrgInOrgaHierarchies");
                });
            ...
            modelBuilder.Entity("CommiteeDatabase.Models.Domains.Commitee", b =>
                {
                    ...
                    b.Property<int?>("CommitteeSecretaryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CommitteeSecretaryId")
                        .IsUnique()
                        .HasFilter("[CommitteeSecretaryId] IS NOT NULL");

                    b.HasIndex("CurrenHeadUnitId")
                        .IsUnique()
                        .HasFilter("[CurrenHeadUnitId] IS NOT NULL");
            ...
            modelBuilder.Entity("CommiteeDatabase.Models.Domains.CommiteeTask", b =>
                {
                    ...
                    b.Property<string>("CloseReopenReason")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTimeOffset?>("CompleteReasonDate")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("CommiteeDatabase.Models.Domains.Survey", b =>
                {
                    ...
                    b.Property<string>("SurveyEndDate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.UpdateTaskLogMainAssignedUser", b =>
                {
                    ...
                    b.Property<string>("NewFullNameAr")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NewFullNameEn")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("NewMainAssignedUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeTaskEscalation", b =>
                {
                    b.HasOne("CommiteeAndMeetings.DAL.CommiteeDomains.ComiteeTaskCategory", "ComiteeTaskCategory")
                        .WithMany("CommiteeTaskEscalations")
                    ...
                    b.HasOne("CommiteeAndMeetings.DAL.Domains.User", "NewMainAssinedUser")
                        .WithMany()
                        .HasForeignKey("NewMainAssinedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("NewMainAssinedUser");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeTaskMultiMissionUser", b =>
                {
                    b.HasOne("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeTaskMultiMission", "CommiteeTaskMultiMission")
                        .WithMany("CommiteeTaskMultiMissionUsers")
                        .HasForeignKey("CommiteeTaskMultiMissionId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                    ...
                    b.Navigation("CommiteeTaskMultiMission");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.GroupUsers", b =>
                {
                    b.HasOne("CommiteeAndMeetings.DAL.Domains.Group", "Group")
                        .WithMany("GroupUsers")
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.Domains.UserRoleRequest", b =>
                {
                    ...
                    b.HasOne("CommiteeAndMeetings.DAL.Domains.User", "UpdatedByUser")
                        .WithMany()
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.MeetingAttendee", b =>
                {
                    b.HasOne("CommiteeAndMeetings.DAL.Domains.User", "AlternativeAttendee")
                        .WithMany()
                        .HasForeignKey("AlternativeAttendeeId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("CommiteeAndMeetings.DAL.Domains.User", "UserDelegate")
                        .WithMany()
                        .HasForeignKey("UserDelegateUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("AlternativeAttendee");

                    b.Navigation("Attendee");

                    b.Navigation("Meeting");

                    b.Navigation("UserDelegate");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.MeetingDomains.MeetingCoordinator", b =>
                {
                    b.HasOne("CommiteeAndMeetings.DAL.Domains.User", "AlternativeCoordinator")
                        .WithMany()
                        .HasForeignKey("AlternativeCoordinatorId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("AlternativeCoordinator");
            ...
            modelBuilder.Entity("CommiteeDatabase.Models.Domains.Commitee", b =>
                {
                    ...
                    b.HasOne("CommiteeAndMeetings.DAL.Domains.User", "CommitteeSecretary")
                        .WithOne("CommitteeSecretary")
                        .HasForeignKey("CommiteeDatabase.Models.Domains.Commitee", "CommitteeSecretaryId");

                    b.HasOne("CommiteeAndMeetings.DAL.Domains.User", "CurrenHeadUnit")
                        .WithOne("CurrenHeadUnit")
                        .HasForeignKey("CommiteeDatabase.Models.Domains.Commitee", "CurrenHeadUnitId");
                    ...
                    b.Navigation("CommitteeSecretary");
            ...
            modelBuilder.Entity("CommiteeDatabase.Models.Domains.SurveyAnswer", b =>
                {
                    ...
                    b.HasOne("CommiteeAndMeetings.DAL.MeetingDomains.MeetingComment", "MeetingComment")
                        .WithMany("SurveyAnswers")
                        .HasForeignKey("MeetingCommentId")
                        .OnDelete(DeleteBehavior.ClientCascade);
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.ComiteeTaskCategory", b =>
                {
                    b.Navigation("CommiteeTaskEscalations");
                });
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeTaskMultiMission", b =>
                {
                    b.Navigation("CommiteeTaskMultiMissionUsers");
                });
