...
namespace CommiteeAndMeetings.BLL.Migrations
{
    ...
    [Migration("20210531111120_AlterCommitteUserRolesTableRemoveCreatedbyRole")]
    partial class AlterCommitteUserRolesTableRemoveCreatedbyRole
    {
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeRole", b =>
                {
                    ...
                    b.HasIndex("CreatedByRoleId")
                        .IsUnique()
                        .HasFilter("[CreatedByRoleId] IS NOT NULL");
            ...
            modelBuilder.Entity("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeRole", b =>
                {
                    b.HasOne("CommiteeDatabase.Models.Domains.CommiteeUsersRole", "CreatedByRole")
                        .WithOne("Role")
                        .HasForeignKey("CommiteeAndMeetings.DAL.CommiteeDomains.CommiteeRole", "CreatedByRoleId")
                        .OnDelete(DeleteBehavior.Restrict);
