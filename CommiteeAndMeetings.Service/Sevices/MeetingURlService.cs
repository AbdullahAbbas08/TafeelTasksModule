...
{
    public class MeetingURlService : BusinessService<MeetingURl, MeetingURlDTO>, IMeetingURlService
    {
        public MeetingURlService(IUnitOfWork unitOfWork, IMapper mapper, IStringLocalizer stringLocalizer, ISecurityService securityService, IHelperServices.ISessionServices sessionServices, IOptions<AppSettings> appSettings)
