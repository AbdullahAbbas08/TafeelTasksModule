...
namespace CommiteeAndMeetings.Service.Sevices
{
    public class TokenStoreService : ITokenStoreService
    {
        ...
        {
            IEnumerable<UserRole> EnabledUserRoles = user.UserRoleUsers
            ...
            var commiteeUsersRole = _uow.GetRepository<CommiteeUsersRole>().GetAll().Where(x => x.UserId == user.UserId && x.Enabled).FirstOrDefault();
            var commiteeUsersRoleId = 0;
            if (commiteeUsersRole != null)
            {
                commiteeUsersRoleId = commiteeUsersRole.CommiteeUsersRoleId;
            }
           string orgName = string.IsNullOrEmpty(DefaultUserRole.Organization.OrganizationNameEn) ? DefaultUserRole.Organization.OrganizationNameAr : DefaultUserRole.Organization.OrganizationNameEn;
            var claims = new List<Claim>
            {
                ...
                new Claim(_dataProtectService.Encrypt("CurrentRoleId"), _dataProtectService.Encrypt(DefaultUserRole.RoleId.ToString()), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim(_dataProtectService.Encrypt("CurrentRoleNameAr"), _dataProtectService.Encrypt(DefaultUserRole.Role.RoleNameAr.ToString()), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim(_dataProtectService.Encrypt("CurrentRoleNameEn"), _dataProtectService.Encrypt(DefaultUserRole.Role.RoleNameEn.ToString()), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim(_dataProtectService.Encrypt("CurrentOrganizationId"), _dataProtectService.Encrypt(DefaultUserRole.OrganizationId.ToString()), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim(_dataProtectService.Encrypt("CurrentOrganizationNameEn"), _dataProtectService.Encrypt(orgName), ClaimValueTypes.String, _configuration.Value.Issuer),

                new Claim(_dataProtectService.Encrypt("CurrentUserRoleId"), _dataProtectService.Encrypt(commiteeUsersRoleId.ToString()), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim(_dataProtectService.Encrypt("UserFullNameAr"), _dataProtectService.Encrypt(user.FullNameAr), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim(_dataProtectService.Encrypt("UserFullNameEn"), _dataProtectService.Encrypt(user.FullNameEn), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim(_dataProtectService.Encrypt("CurrentOrganizationNameAr"), _dataProtectService.Encrypt(DefaultUserRole.Organization.OrganizationNameAr), ClaimValueTypes.String, _configuration.Value.Issuer),
                new Claim(_dataProtectService.Encrypt("UserRoleId"), _dataProtectService.Encrypt(DefaultUserRole.UserRoleId.ToString()), ClaimValueTypes.String, _configuration.Value.Issuer),
            ...
            //  UserRole LastAndCurrentLogedInUserRole = null;
