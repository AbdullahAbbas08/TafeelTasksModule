...
{
    public class CommitePermissionService : BusinessService<CommitePermission, CommitePermissionDTO>, ICommiteePermissionService
    {
        IUnitOfWork _unitOfWork;
        IHelperServices.ISessionServices _sessionServices;
        public CommitePermissionService(IUnitOfWork unitOfWork, IMapper mapper, IStringLocalizer stringLocalizer, ISecurityService securityService, IHelperServices.ISessionServices sessionServices, IOptions<AppSettings> appSettings)
