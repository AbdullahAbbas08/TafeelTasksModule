...
namespace CommiteeAndMeetings.Service.ISevices
{
    public interface ICommiteeTaskService : IBusinessService<CommiteeTask, CommiteeTaskDTO>
    {
        ...
        List<CommiteeTaskDTO> GetAllForPrint(TaskFilterEnum requiredTasks, int? CommiteeId, int? ComiteeTaskCategoryId, string SearchText, int? userId = null, ParamsSearchFilterDTO paramsSearchFilterDTO = null,int? organizationId = null);
        ...
        CommiteetaskMultiMissionDTO changeState(int missionId,List<int> usersIds,string TaskTitle);
