...
{
    public class ViewTransactionsReportLateResultDTO
    {
        ...
        public string ToOrganizationFullPathNameAr { get; set; }
        public string FromOrganizationFullPathNameAr { get; set; }
