...
{
    [Keyless]
    public partial class VmTransactionActionRecipientSavedView
    {
        ...
        [Required]
        [StringLength(1)]
        public string TransactionActionRecipientStatusesCreatedOn { get; set; }
        [Required]
        [StringLength(1)]
        public string TransactionActionRecipientStatusesCreatedBy { get; set; }
        [Required]
        [Column("TransactionActionRecipientStatusesCreatedByNameAR")]
        [StringLength(1)]
        public string TransactionActionRecipientStatusesCreatedByNameAr { get; set; }
        [Required]
        [StringLength(1)]
        public string TransactionActionRecipientStatusesCreatedByNameEn { get; set; }
        [Required]
        [StringLength(1)]
        public string TransactionActionRecipientStatusesCreatedByNameFn { get; set; }
        ...
        public string ArchiveReasonNameFn { get; set; }
    }
}
